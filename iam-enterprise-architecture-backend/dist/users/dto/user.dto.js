...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[A-Z][a-z]+(\s[A-Z][a-z]+)+$/, { message: 'Full name must contain at least two words starting from capital letters' }),
    __metadata("design:type", String)
], NewUserDto.prototype, "fullName", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
