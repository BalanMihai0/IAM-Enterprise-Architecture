    ...
    <div>
      ...
      <section id="about" className="bg-gray-300 py-12">
        <div className="container mx-auto text-center">
          <Typography variant="h2" className="text-3xl font-bold">About BlackHawk Security</Typography>
          <Typography className="mt-4 mx-52">We are a very diverse team of hardened security professionals. Look at how threatening we are. Not convinced? Well idk what to tell you.</Typography>
          <div className='flex'>
      ...
      <section id="testimonials" className="container mx-auto py-12">
        ...
        <div className="mt-8 flex gap-3">
          <Card className="bg-gray-300 p-6 rounded-lg w-1/3">
            <CardBody>
              <Typography>"Excellent service! They protected my son against terrorists! Highly recommend."</Typography>
              <Typography className="mt-4">- Totally legitimate client 1</Typography>
            </CardBody>
          </Card>
          <Card className="bg-gray-300 p-6 rounded-lg w-1/3">
            <CardBody>
              <Typography>"If you need someone to be your bodyguard, these are the guys. They're so macho and strong and their masculine aura intimidates everyone."</Typography>
              <Typography className="mt-4">- Totally legitimate client 2</Typography>
            </CardBody>
          </Card>
          <Card className="bg-gray-300 p-6 rounded-lg w-1/3">
            <CardBody>
              <Typography>"I hired them to guard the moon base. They're so dedicated to the job, they still haven't returned, even though we stop supplying them oxygen! 10/10!"</Typography>
              <Typography className="mt-4">- Totally legitimate client 3</Typography>
            </CardBody>
          </Card>
        </div>
      </section>
      ...
      <section id="contact" className="bg-gray-300 py-12">
        <div className="container mx-auto text-center">
          <Typography variant="h2" className="text-3xl font-bold">Get in Touch</Typography>
          <form className="mt-8">
            <div className="flex flex-col space-y-4">
              <Input type="text" placeholder="Name" className="p-4 rounded-lg bg-gray-100 border border-gray-600 " />
              <Input type="email" placeholder="Email" className="p-4 rounded-lg bg-gray-700 border border-gray-600" />
              <Input type="text" placeholder="Phone Number" className="p-4 rounded-lg bg-gray-700 border border-gray-600" />
              <Textarea placeholder="Message" className="p-4 rounded-lg bg-gray-700 border border-gray-600" />
            </div>
            <Button type="submit" variant="gradient" color="black" className="mt-4">Send Message</Button>
          </form>
          <div className="mt-8">
            <Typography>Phone: (123) 456-7890</Typography>
            <Typography>Email: info@blackhawksecurity.com</Typography>
            <Typography>Address: 123 Security Lane, Safe City, ST 12345</Typography>
          </div>
